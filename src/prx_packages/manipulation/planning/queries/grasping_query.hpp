        ...
        namespace manipulation
        {
            ...
            class grasping_query_t : public plan::query_t
            {
              ...
              public:                
                ...
                grasping_query_t(const util::space_t* state_space, const util::space_t* control_space, movable_body_plant_t* object_id, int grasping_id, sim::state_t* object_initial_state,util::config_t& retract_config);
                 ...
                 */
                virtual void setup(const util::space_t* state_space, const util::space_t* control_space, movable_body_plant_t* object, int grasping_id, sim::state_t* object_initial_state,util::config_t& retract_config);
                 ...
                 * @param retract_config Relative retracted configuration for the end effector.
                 */
                virtual void setup(movable_body_plant_t* object_id, int grasping_id, sim::state_t* object_initial_state,util::config_t& retract_config);
                ...
                /**
                 * @brief Helping function for getting the config of the object from its state.
                 * @details Helping function for getting the config of the object from its state.
                 * 
                 * @param config The configuration of the object.
                 */
                virtual void get_object_configuration(util::config_t& config);
                ...
                /** @brief The mode used to release the object */
                int release_mode;
