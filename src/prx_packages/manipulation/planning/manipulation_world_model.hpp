    ...
    namespace packages
    {
        ...
        namespace manipulation
        {
            ...
            class manipulation_context_info_t : public plan::planning_context_info_t
            {
                ...
                public:
                    manipulation_context_info_t(plan::world_model_t* model, manipulator_t* manipulator, std::string full_arm_context_name, std::string arm_context_name, std::string end_effector_context_name, std::string base_link, std::string end_link)
                    {
            ...
            class manipulation_world_model_t : public plan::world_model_t
            {
              ...
              public:
                 ...
                 */
                virtual void engage_grasp( sim::plan_t& plan, int grasping_mode, bool static_relative_flag );
                 ...
                 * @return [description]
                 */
                virtual int get_current_grasping_mode();
                 ...
                 * @return True if the IK_steering found a solution, otherwise false.
                 */
                virtual bool IK_steering( sim::plan_t& result_plan, sim::state_t* result_state, const util::space_point_t* start_state, const util::space_point_t* final_state, const util::config_t& goal_config);
                ...
                /**
                 * @brief Converts the found plan to the desire control space.
                 * @details Converts the found plan to the desire control space. The returned plan might not be in the correct 
                 * control space. If the returned control space is a subset of the output_space the the rest values 
                 * will be the same as the space has them. 
                 * 
                 * @param output_plan The new output plan.
                 * @param output_space The desired output control space;
                 * @param input_plan The plan that we want to convert to the new output plan.
                 * @param input_space The space that the input plan is using.
                 */
                virtual void convert_plan(sim::plan_t& output_plan, const util::space_t* output_space, const sim::plan_t& input_plan, const util::space_t* input_space);

                void enable_IK_steering(bool enable, std::string steer_context)
                {
                    IK_steer_paths = enable;
                    IK_steer_context = steer_context;
                }
