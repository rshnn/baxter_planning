...
if(NOT "include;/usr/include;/opt/ros/indigo/include " STREQUAL " ")
  set(prx_simulation_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'prx_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Kostas Bekris <kostas.bekris@cs.rutgers.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/rshnn/Documents/CS598/pracsys/devel/lib;/opt/ros/indigo/lib)
